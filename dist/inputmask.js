...
var _inputmask = _interopRequireDefault(__webpack_require__(17));
...
var _inputHandling = __webpack_require__(15);
var _eventruler = __webpack_require__(16);
...
exports.keys = exports.keyCode = exports.ignorables = void 0;
exports.toKey = toKey;
...
var ignorables = exports.ignorables = {
  "Alt": 18,
  "AltGraph": 18,
  "ArrowDown": 40,
  "ArrowLeft": 37,
...
var keyCode = exports.keyCode = _objectSpread({
  "c": 67,
  "x": 88,
  "z": 90,
...
var keys = exports.keys = Object.entries(keyCode).reduce(function (acc, _ref3) {
...
function getPlaceholder(pos, test, returnPL) {
  ...
  if (test.placeholder !== undefined || returnPL === true) {
    if (test["static"] === true && test.generated !== true) {
      ...
      return (returnPL ? pos <= nextPos : pos < nextPos) ? test.def : typeof test.placeholder === "function" ? test.placeholder(opts) : test.placeholder;
    } else {
        ...
        function mergeLoc(altNdx) {
          ...
          if (locNdx === undefined) {
            ...
            if (targetMatch.mloc[locNdx] === undefined) {
              ...
              targetMatch.mloc[locNdx].push(":".concat(targetMatch.alternation)); //add alternation index
            }
...
exports["default"] = void 0;
var _extend = _interopRequireDefault(__webpack_require__(18));
var _window = _interopRequireDefault(__webpack_require__(10));
var _data = _interopRequireDefault(__webpack_require__(19));
...
var _default = exports["default"] = {
  ...
  ignorables: Object.keys(_keycode.ignorables),
  isComplete: null,
  ...
  _createClass(DateObject, [{
    ...
    value: function setValue(dateObj, value, fcode, targetProp, dateOperation) {
      ...
      if (dateOperation !== undefined) {
        ...
        if (datavalue !== "" && !isNaN(datavalue) || targetProp === "ampm" || fcode === "mmm" || fcode === "mmmm") dateOperation.call(dateObj._date, datavalue);
      }
    }
  }, {
    key: "reset",
...
function isValidDate(dateParts, currentResult, opts) {
  ...
  if (dateParts.rawday === undefined || !isFinite(dateParts.rawday) && new Date(dateParts.date.getFullYear(), isFinite(dateParts.rawmonth) ? dateParts.month : dateParts.date.getMonth(), 0).getDate() >= dateParts.day || dateParts.day == "29" && (!isFinite(dateParts.rawyear) || dateParts.rawyear === undefined || dateParts.rawyear === "") || new Date(dateParts.date.getFullYear(), isFinite(dateParts.rawmonth) ? dateParts.month : dateParts.date.getMonth(), 0).getDate() >= dateParts.day) {
    return currentResult;
  } else {
...
if (document && document.head && document.head.attachShadow && _window["default"].customElements && _window["default"].customElements.get("input-mask") === undefined) {
  var InputmaskElement = /*#__PURE__*/function (_HTMLElement) {
    ...
    function InputmaskElement() {
      ...
      im.dataAttribute = "";
      im.mask(_this.input);
      _this.input.inputmask.shadowRoot = shadow; //make the shadowRoot available
      return _this;
    }
    _createClass(InputmaskElement, [{
